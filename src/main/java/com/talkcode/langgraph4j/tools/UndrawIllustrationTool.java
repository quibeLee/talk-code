package com.talkcode.langgraph4j.tools;
...
import com.talkcode.langgraph4j.model.enums.ImageCategoryEnum;
...
public class UndrawIllustrationTool {
     ...
     * 个人的Undraw API Key
     */
    private static final String UNDRAW_API_KEY = "9SMsYpCjXCftNdh3cu_8Q";
    ...
    public List<ImageResource> searchIllustrations(@P("搜索关键词") String query) {
        ...
        int searchCount = 12;
        String apiUrl = String.format(UNDRAW_API_URL, UNDRAW_API_KEY, query, query);
